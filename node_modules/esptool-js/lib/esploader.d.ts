...
export declare class ESPLoader {
    ...
    read_packet(op?: number | null, timeout?: number): Promise<[number, Uint8Array]>;
    ...
    read_flash(addr: number, size: number, onPacketReceived?: FlashReadCallback): Promise<Uint8Array>;
